...
export default function InvoicePreviewModal({ isOpen, onClose, invoice, onDownload }) {
  ...
  return (
    <div 
      className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/70 backdrop-blur-sm p-4 sm:p-6 overflow-hidden"
      style={{ colorScheme: 'light' }} // Forces browser elements to light mode
    >
      <div className="!bg-slate-100 border border-slate-300 shadow-2xl rounded-xl w-full max-w-4xl max-h-[95vh] flex flex-col relative animate-in fade-in zoom-in duration-200">
        ...
        <div className="flex-1 overflow-y-auto p-4 md:p-8 flex justify-center custom-scrollbar">
          ...
          {/* THE "WHITE PAPER" - Enforced light mode colors */}
          <div 
            ref={printRef} 
            ...
            style={{ backgroundColor: '#ffffff', color: '#0f172a' }} // Hard fallback
          >
            <div className="space-y-12">
              ...
              {/* Invoice Date & Metadata Summary Card */}
              <div className="grid grid-cols-3 gap-4 border !border-slate-200 !bg-slate-50 p-5 rounded-lg text-xs font-medium">
                <div>
